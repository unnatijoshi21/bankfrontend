...
const Debit = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // Validation: check if the entered amount is a positive number and if the amount is less than or equal to balance
    ...
    alert(`Amount of ${amount} debited successfully. New balance: ${updatedBalance.toFixed(2)}`);
  };
  ...
  return (
    <div style={containerStyle}>
      ...
      <form onSubmit={handleSubmit} style={formStyle}>
        ...
        <button type="submit" style={buttonStyle}>Debit</button>
      </form>
